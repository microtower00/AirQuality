...
AirQualityRetriever::AirQualityRetriever(QString apik) :
    apikey(apik)
{
...
void AirQualityRetriever::retrieveHistorical(const double& lat, const double& lon, const QDate& start, const QDate& end) const
{
