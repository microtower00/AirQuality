#ifndef FPICKERCONTROLLER_H
#define FPICKERCONTROLLER_H
 ...
 */
class FPickerController : public QMainWindow
{
    Q_OBJECT
public:
    /*!
     ...
     */
    explicit FPickerController(QWidget *parent = nullptr);
